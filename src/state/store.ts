...
import { metresPerSecToKph, projectOntoPath, type LatLng } from '../geo/geo.ts';
import type { TransitFeed } from '../gtfs/feed.ts';
import { adherenceFor, presentEta, type Adherence, type PresentedEta } from '../eta/present.ts';
import type {
